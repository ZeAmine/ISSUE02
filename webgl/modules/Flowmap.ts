...
import { getDoubleRenderTarget, getFullscreenTriangle } from '../utils/Utils3D'

// import type { FlowmapMaterial } from '../materials/flowmap/index.js'
...
export class Flowmap {
  ...
  public screenCamera: OrthographicCamera
  public screenTriangle: BufferGeometry
  public screen: Mesh

  constructor(
    renderer: WebGLRenderer,
    { size = 128, falloff = 0.15, alpha = 1, dissipation = 0.98 }: FlowmapOptions = {}
  ) {
